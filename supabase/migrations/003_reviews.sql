...
-- Public read: anyone can read reviews for active products. We don't bother
-- joining to products here — RLS on products already hides inactive ones,
-- and an orphan review surfacing briefly is harmless.
create policy "reviews_public_read" on reviews
  for select using (true);
